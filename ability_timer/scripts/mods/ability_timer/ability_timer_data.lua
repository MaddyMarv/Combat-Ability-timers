...
local widgets = {
	{
		...
		sub_widgets = {
			{
				setting_id = "group_display_base",
				display_name = mod:localize("group_display_base"),
				type = "group",
				sub_widgets = {
					{
			...
			{
				setting_id = "group_display_colors_static",
				display_name = mod:localize("group_display_colors_static"),
				type = "group",
				sub_widgets = {
					{
						setting_id = "bar_color",
						display_name = mod:localize("bar_color"),
						type = "color",
						default_value = { 255, 255, 255, 255 },
					},
					{
						setting_id = "text_color",
						display_name = mod:localize("text_color"),
						type = "color",
						default_value = { 255, 255, 255, 255 },
					},
				},
			},
			{
				...
				sub_widgets = {
					...
					{
						setting_id = "use_progress_color_text",
						display_name = mod:localize("use_progress_color_text"),
						type = "checkbox",
						default_value = true,
					},
					{
						setting_id = "high_color",
						display_name = mod:localize("high_color"),
						type = "color",
						default_value = { 255, 0, 255, 0 },
					},
					{
						setting_id = "mid_color",
						display_name = mod:localize("mid_color"),
						type = "color",
						default_value = { 255, 255, 255, 0 },
					},
					{
						setting_id = "low_color",
						display_name = mod:localize("low_color"),
						type = "color",
			...
			},
			{
				...
				sub_widgets = {
					...
					},
					{
						...
						display_name = mod:localize("scriers_use_progress_color"),
						type = "checkbox",
						default_value = true,
					},
					{
						setting_id = "peril_low_color",
						display_name = mod:localize("peril_low_color"),
						type = "color",
						default_value = { 255, 255, 105, 180 },
					},
					{
						setting_id = "peril_high_color",
						display_name = mod:localize("peril_high_color"),
						type = "color",
						default_value = { 255, 139, 0, 0 },
					},
				},
			},
		},
	...
	{
		setting_id = "position_settings_bar",
		type = "group",
		tab = "Position",
		sub_widgets = {
			{
				setting_id = "bar_position_x",
				display_name = mod:localize("bar_position_x"),
				type = "numeric",
				default_value = 0,
				range = { -1920, 1920 },
				decimals_number = 0,
			...
			{
				setting_id = "bar_position_y",
				display_name = mod:localize("bar_position_y"),
				type = "numeric",
				default_value = 0,
				range = { -1080, 1080 },
				decimals_number = 0,
	...
	{
		setting_id = "position_settings_timer",
		type = "group",
		tab = "Position",
		sub_widgets = {
			{
				setting_id = "timer_position_x",
				display_name = mod:localize("timer_position_x"),
				type = "numeric",
				default_value = 0,
				range = { -1920, 1920 },
				decimals_number = 0,
			...
			{
				setting_id = "timer_position_y",
				display_name = mod:localize("timer_position_y"),
				type = "numeric",
				default_value = 0,
				range = { -1080, 1080 },
				decimals_number = 0,
	...
	{
		setting_id = "position_settings_charges",
		type = "group",
		tab = "Position",
		sub_widgets = {
			{
				setting_id = "charges_position_x",
				display_name = mod:localize("charges_position_x"),
				type = "numeric",
				default_value = 0,
				range = { -1920, 1920 },
				decimals_number = 0,
			...
			{
				setting_id = "charges_position_y",
				display_name = mod:localize("charges_position_y"),
				type = "numeric",
				default_value = 0,
				range = { -1080, 1080 },
				decimals_number = 0,
	...
	{
		setting_id = "position_settings_health",
		type = "group",
		tab = "Position",
		sub_widgets = {
			{
				setting_id = "health_position_x",
				display_name = mod:localize("health_position_x"),
				type = "numeric",
				default_value = 0,
				range = { -1920, 1920 },
				decimals_number = 0,
			...
			{
				setting_id = "health_position_y",
				display_name = mod:localize("health_position_y"),
				type = "numeric",
				default_value = 0,
				range = { -1080, 1080 },
				decimals_number = 0,
